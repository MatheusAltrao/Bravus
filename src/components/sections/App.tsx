    ...
    <section id="app">
      <header>
        ...
        <p className="description text-left md:text-center">
          Apresentamos o nosso novo aplicativo exclusivo, uma ferramenta
          completa para elevar sua jornada no mundo do Jiu Jitsu.
        </p>
      </header>
      <div className="flex items-center justify-center flex-col w-full space-y-4 md:space-y-8 max-w-[1000px] mx-auto">
        <div className="flex items-start md:flex-row flex-col justify-between gap-4 w-full">
          <AppCard
            title="Notícias e atualizações da Bravus"
          ...
          <AppCard
            ...
            description="Com o aplicativo da Academia Bravus, a evolução está literalmente em suas mãos. Acompanhe cada passo, desde o treinamento até a graduação, e experimente uma nova maneira de se envolver com nossa escola de Jiu-Jitsu."
          />
        </div>
